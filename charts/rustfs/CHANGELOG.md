...
* chore: update CHANGELOG.md for merged changes ([2d2d004](https://github.com/CloudPirates-io/helm-charts/commit/2d2d004))
* chore: update CHANGELOG.md for merged changes ([ec87f5e](https://github.com/CloudPirates-io/helm-charts/commit/ec87f5e))
* update values.schema.json (#847) ([d1ab740](https://github.com/CloudPirates-io/helm-charts/commit/d1ab740))
...
* chore: update CHANGELOG.md for merged changes ([0504049](https://github.com/CloudPirates-io/helm-charts/commit/0504049))
* chore: update CHANGELOG.md for merged changes ([bdd6dfd](https://github.com/CloudPirates-io/helm-charts/commit/bdd6dfd))
